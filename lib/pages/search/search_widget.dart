            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 42.0, 20.0, 0.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(32.0, 150.0, 32.0, 0.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                            ...
                            children: [
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'i495cfr3' /* Digite o nome ou parte do nome */,
                                        ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    if (_model.textFieldSearchController.text !=
                                        '')
                                      FutureBuilder<ApiCallResponse>(
                                        future: GetByNameSuperHeroCall.call(
                                          name: _model
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final listViewGetByNameSuperHeroResponse =
                                              snapshot.data!;
                                          return Builder(
                                            builder: (context) {
                                              final results = getJsonField(
                                                listViewGetByNameSuperHeroResponse
                                                    .jsonBody,
                                                r'''$.results''',
