...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF8B00FF);
  late Color secondary = const Color(0xFF6500BA);
  late Color tertiary = const Color(0xFFB3B0B8);
  late Color alternate = const Color(0xFF7C7A80);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF1E1F24);
  late Color primaryBackground = const Color(0xFF2B2C33);
  late Color secondaryBackground = const Color(0xFF454652);
  late Color accent1 = const Color(0xFF39CC59);
  late Color accent2 = const Color(0xFFE03F3F);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFE03F3F);
